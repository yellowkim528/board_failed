...
public class Main {
    public static void main(String[] args) {
        DrawingBoard drawingBoard = new DrawingBoard(10);

        drawingBoard.addShape(new Circle(10));
        drawingBoard.addShape(new Rectangle(10,10));
        drawingBoard.addShape(new Triangle(10,10));

        drawingBoard.runCalculateArea();
    }
}
